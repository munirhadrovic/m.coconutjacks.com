<?php
	$adresa="5370 Bonita Beach Rd Bonita Springs, FL 34134"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2396767777;// Broj koji se poziva na dugme CALL US
